...
const markupTemplating: RefractorLanguage = Object.assign(
  function markupTemplatingGrammar(Prism: any): void {
  ...
  {
    aliases: [],
    displayName: 'markup-templating',
  },
);

const twig: RefractorLanguage = Object.assign(
  function twigGrammar(Prism: any): void {
